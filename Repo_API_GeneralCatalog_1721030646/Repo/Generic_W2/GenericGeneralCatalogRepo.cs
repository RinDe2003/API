...
namespace Repo_API_GeneralCatalog_1721030646.Repo.Generic_W2
{
    public class GenericGeneralCatalogRepo<T> : IGenericRepo<T> where T : class
    {
        private readonly GeneralCatalogContext _context;
        protected readonly DbSet<T> _dbSet;
        public GenericGeneralCatalogRepo(GeneralCatalogContext dbContext)
        {
            _context = dbContext;
